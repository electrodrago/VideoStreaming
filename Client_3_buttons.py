...
class Client_3_buttons:
	...
	def createWidgets(self):
		...
		self.info1.grid(row=2, column=1, sticky=W + E + N + S, padx=5, pady=5)
		...
		self.info2.grid(row=3, column=1, sticky=W + E + N + S, padx=5, pady=5)
		...
		self.info3.grid(row=4, column=1, sticky=W + E + N + S, padx=5, pady=5)
		self.donvi3 = Label(self.master)
		self.donvi3["text"] = "Bytes/second"
		self.donvi3.grid(row=4, column=2, sticky=W + E + N + S, padx=5, pady=5)
